defmodule Sui.Rpc.V2alpha.DatatypeDescriptor do
  @moduledoc """
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_REPEATED,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2alpha.TypeParameter",
          default_value: nil,
          options: nil,
          oneof_index: nil,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_ENUM,
          type_name: ".sui.rpc.v2alpha.DatatypeDescriptor.DatatypeKind",
          default_value: nil,
          options: nil,
          oneof_index: 4,
          json_name: "kind",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_REPEATED,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2alpha.VariantDescriptor",
          default_value: nil,
          options: nil,
          oneof_index: nil,
          json_name: "variants",
  ...
  field :abilities, 5, repeated: true, type: Sui.Rpc.V2alpha.Ability, enum: true

  field :type_parameters, 6,
    repeated: true,
    type: Sui.Rpc.V2alpha.TypeParameter,
    json_name: "typeParameters"

  field :kind, 7,
    proto3_optional: true,
    type: Sui.Rpc.V2alpha.DatatypeDescriptor.DatatypeKind,
    enum: true

  field :fields, 8, repeated: true, type: Sui.Rpc.V2alpha.FieldDescriptor
  field :variants, 9, repeated: true, type: Sui.Rpc.V2alpha.VariantDescriptor
end
