defmodule Sui.Rpc.V2alpha.OpenSignatureBody do
  @moduledoc """
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          type: :TYPE_ENUM,
          type_name: ".sui.rpc.v2alpha.OpenSignatureBody.Type",
          default_value: nil,
          options: nil,
          oneof_index: 0,
          json_name: "type",
  ...
  field :type, 1, proto3_optional: true, type: Sui.Rpc.V2alpha.OpenSignatureBody.Type, enum: true
  field :type_name, 2, proto3_optional: true, type: :string, json_name: "typeName"

  field :type_parameter_instantiation, 3,
    repeated: true,
    type: Sui.Rpc.V2alpha.OpenSignatureBody,
    json_name: "typeParameterInstantiation"
