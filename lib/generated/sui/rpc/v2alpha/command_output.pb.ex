defmodule Sui.Rpc.V2alpha.CommandOutput do
  ...
  field :argument, 1, proto3_optional: true, type: Sui.Rpc.V2beta.Argument
  field :value, 2, proto3_optional: true, type: Sui.Rpc.V2beta.Bcs
