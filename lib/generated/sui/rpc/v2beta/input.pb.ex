defmodule Sui.Rpc.V2beta.Input do
  @moduledoc """
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          type: :TYPE_ENUM,
          type_name: ".sui.rpc.v2beta.Input.InputKind",
          default_value: nil,
          options: nil,
          oneof_index: 0,
          json_name: "kind",
  ...
  field :kind, 1, proto3_optional: true, type: Sui.Rpc.V2beta.Input.InputKind, enum: true
