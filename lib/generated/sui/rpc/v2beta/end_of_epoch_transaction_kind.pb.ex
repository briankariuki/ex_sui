defmodule Sui.Rpc.V2beta.EndOfEpochTransactionKind do
  @moduledoc """
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.AuthenticatorStateExpire",
          default_value: nil,
          options: nil,
          oneof_index: 0,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.ExecutionTimeObservations",
          default_value: nil,
          options: nil,
          oneof_index: 0,
  ...
  field :change_epoch, 2, type: Sui.Rpc.V2beta.ChangeEpoch, json_name: "changeEpoch", oneof: 0

  field :authenticator_state_expire, 3,
    type: Sui.Rpc.V2beta.AuthenticatorStateExpire,
    json_name: "authenticatorStateExpire",
    oneof: 0

  field :execution_time_observations, 4,
    type: Sui.Rpc.V2beta.ExecutionTimeObservations,
    json_name: "executionTimeObservations",
    oneof: 0
