defmodule Sui.Rpc.V2beta.CheckpointSummary do
  @moduledoc """
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.EndOfEpochData",
          default_value: nil,
          options: nil,
          oneof_index: 9,
  ...
  field :commitments, 10, repeated: true, type: Sui.Rpc.V2beta.CheckpointCommitment

  field :end_of_epoch_data, 11,
    proto3_optional: true,
    type: Sui.Rpc.V2beta.EndOfEpochData,
    json_name: "endOfEpochData"
