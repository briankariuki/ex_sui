defmodule Sui.Rpc.V2beta.TransactionEffects do
  @moduledoc """
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.ExecutionStatus",
          default_value: nil,
          options: nil,
          oneof_index: 3,
          json_name: "status",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.GasCostSummary",
          default_value: nil,
          options: nil,
          oneof_index: 5,
          json_name: "gasUsed",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.ChangedObject",
          default_value: nil,
          options: nil,
          oneof_index: 7,
          json_name: "gasObject",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_REPEATED,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.UnchangedSharedObject",
          default_value: nil,
          options: nil,
          oneof_index: nil,
  ...
  field :status, 4, proto3_optional: true, type: Sui.Rpc.V2beta.ExecutionStatus
  field :epoch, 5, proto3_optional: true, type: :uint64

  field :gas_used, 6,
    proto3_optional: true,
    type: Sui.Rpc.V2beta.GasCostSummary,
    json_name: "gasUsed"
  ...
  field :gas_object, 8,
    proto3_optional: true,
    type: Sui.Rpc.V2beta.ChangedObject,
    json_name: "gasObject"
  ...
  field :unchanged_shared_objects, 13,
    repeated: true,
    type: Sui.Rpc.V2beta.UnchangedSharedObject,
    json_name: "unchangedSharedObjects"
