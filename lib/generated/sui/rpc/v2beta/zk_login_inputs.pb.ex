defmodule Sui.Rpc.V2beta.ZkLoginInputs do
  @moduledoc """
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.ZkLoginProof",
          default_value: nil,
          options: nil,
          oneof_index: 0,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.ZkLoginClaim",
          default_value: nil,
          options: nil,
          oneof_index: 1,
  ...
  field :proof_points, 1,
    proto3_optional: true,
    type: Sui.Rpc.V2beta.ZkLoginProof,
    json_name: "proofPoints"

  field :iss_base64_details, 2,
    proto3_optional: true,
    type: Sui.Rpc.V2beta.ZkLoginClaim,
    json_name: "issBase64Details"
