defmodule Sui.Rpc.V2beta.ExecutedTransaction do
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.TransactionEffects",
          default_value: nil,
          options: nil,
          oneof_index: 2,
          json_name: "effects",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.TransactionEvents",
          default_value: nil,
          options: nil,
          oneof_index: 3,
          json_name: "events",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_REPEATED,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.BalanceChange",
          default_value: nil,
          options: nil,
          oneof_index: nil,
  ...
  field :transaction, 2, proto3_optional: true, type: Sui.Rpc.V2beta.Transaction
  field :signatures, 3, repeated: true, type: Sui.Rpc.V2beta.UserSignature
  field :effects, 4, proto3_optional: true, type: Sui.Rpc.V2beta.TransactionEffects
  field :events, 5, proto3_optional: true, type: Sui.Rpc.V2beta.TransactionEvents
  ...
  field :balance_changes, 8,
    repeated: true,
    type: Sui.Rpc.V2beta.BalanceChange,
    json_name: "balanceChanges"

  field :input_objects, 10, repeated: true, type: Sui.Rpc.V2beta.Object, json_name: "inputObjects"

  field :output_objects, 11,
    repeated: true,
    type: Sui.Rpc.V2beta.Object,
    json_name: "outputObjects"
end
