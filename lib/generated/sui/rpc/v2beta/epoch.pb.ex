defmodule Sui.Rpc.V2beta.Epoch do
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.ValidatorCommittee",
          default_value: nil,
          options: nil,
          oneof_index: 1,
          json_name: "committee",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.SystemState",
          default_value: nil,
          options: nil,
          oneof_index: 2,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.ProtocolConfig",
          default_value: nil,
          options: nil,
          oneof_index: 8,
  ...
  field :committee, 2, proto3_optional: true, type: Sui.Rpc.V2beta.ValidatorCommittee

  field :system_state, 3,
    proto3_optional: true,
    type: Sui.Rpc.V2beta.SystemState,
    json_name: "systemState"
  ...
  field :protocol_config, 9,
    proto3_optional: true,
    type: Sui.Rpc.V2beta.ProtocolConfig,
    json_name: "protocolConfig"
end
