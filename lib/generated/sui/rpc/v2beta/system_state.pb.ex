defmodule Sui.Rpc.V2beta.SystemState do
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.ValidatorSet",
          default_value: nil,
          options: nil,
          oneof_index: 3,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.StorageFund",
          default_value: nil,
          options: nil,
          oneof_index: 4,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.SystemParameters",
          default_value: nil,
          options: nil,
          oneof_index: 5,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.ValidatorReportRecord",
          default_value: nil,
          options: nil,
          oneof_index: nil,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.StakeSubsidy",
          default_value: nil,
          options: nil,
          oneof_index: 7,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.MoveTable",
          default_value: nil,
          options: nil,
          oneof_index: 14,
  ...
  field :validators, 4, proto3_optional: true, type: Sui.Rpc.V2beta.ValidatorSet

  field :storage_fund, 5,
    proto3_optional: true,
    type: Sui.Rpc.V2beta.StorageFund,
    json_name: "storageFund"

  field :parameters, 6, proto3_optional: true, type: Sui.Rpc.V2beta.SystemParameters
  ...
  field :validator_report_records, 8,
    repeated: true,
    type: Sui.Rpc.V2beta.ValidatorReportRecord,
    json_name: "validatorReportRecords"

  field :stake_subsidy, 9,
    proto3_optional: true,
    type: Sui.Rpc.V2beta.StakeSubsidy,
    json_name: "stakeSubsidy"
