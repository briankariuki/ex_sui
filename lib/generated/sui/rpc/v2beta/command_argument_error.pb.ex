defmodule Sui.Rpc.V2beta.CommandArgumentError do
  @moduledoc """
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_ENUM,
          type_name: ".sui.rpc.v2beta.CommandArgumentError.CommandArgumentErrorKind",
          default_value: nil,
          options: nil,
          oneof_index: 1,
          json_name: "kind",
  ...
  field :kind, 2,
    proto3_optional: true,
    type: Sui.Rpc.V2beta.CommandArgumentError.CommandArgumentErrorKind,
    enum: true

  field :index, 3, proto3_optional: true, type: :uint32
