defmodule Sui.Rpc.V2beta.CheckpointContents do
  @moduledoc """
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta.CheckpointedTransactionInfo",
          default_value: nil,
          options: nil,
          oneof_index: nil,
  ...
  field :transactions, 4, repeated: true, type: Sui.Rpc.V2beta.CheckpointedTransactionInfo
end
