defmodule Sui.Rpc.V2beta2.TransactionKind do
  @moduledoc """
  Transaction type.
  """
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta2.ProgrammableTransaction",
          default_value: nil,
          options: nil,
          oneof_index: 0,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta2.GenesisTransaction",
          default_value: nil,
          options: nil,
          oneof_index: 0,
          json_name: "genesis",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta2.ConsensusCommitPrologue",
          default_value: nil,
          options: nil,
          oneof_index: 0,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta2.AuthenticatorStateUpdate",
          default_value: nil,
          options: nil,
          oneof_index: 0,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta2.EndOfEpochTransaction",
          default_value: nil,
          options: nil,
          oneof_index: 0,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta2.RandomnessStateUpdate",
          default_value: nil,
          options: nil,
          oneof_index: 0,
  ...
  field :programmable_transaction, 2,
    type: Sui.Rpc.V2beta2.ProgrammableTransaction,
    json_name: "programmableTransaction",
    oneof: 0

  field :change_epoch, 100, type: Sui.Rpc.V2beta2.ChangeEpoch, json_name: "changeEpoch", oneof: 0
  field :genesis, 101, type: Sui.Rpc.V2beta2.GenesisTransaction, oneof: 0

  field :consensus_commit_prologue_v1, 102,
    type: Sui.Rpc.V2beta2.ConsensusCommitPrologue,
    json_name: "consensusCommitPrologueV1",
    oneof: 0

  field :authenticator_state_update, 103,
    type: Sui.Rpc.V2beta2.AuthenticatorStateUpdate,
    json_name: "authenticatorStateUpdate",
    oneof: 0

  field :end_of_epoch, 104,
    type: Sui.Rpc.V2beta2.EndOfEpochTransaction,
    json_name: "endOfEpoch",
    oneof: 0

  field :randomness_state_update, 105,
    type: Sui.Rpc.V2beta2.RandomnessStateUpdate,
    json_name: "randomnessStateUpdate",
    oneof: 0
