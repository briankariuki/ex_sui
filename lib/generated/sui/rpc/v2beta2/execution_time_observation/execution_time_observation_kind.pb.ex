defmodule Sui.Rpc.V2beta2.ExecutionTimeObservation.ExecutionTimeObservationKind do
  ...
  field :EXECUTION_TIME_OBSERVATION_KIND_UNKNOWN, 0
  field :MOVE_ENTRY_POINT, 1
