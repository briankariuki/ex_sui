defmodule Sui.Rpc.V2beta2.ConsensusDeterminedVersionAssignments do
  @moduledoc """
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta2.CanceledTransaction",
          default_value: nil,
          options: nil,
          oneof_index: nil,
  ...
  field :canceled_transactions, 3,
    repeated: true,
    type: Sui.Rpc.V2beta2.CanceledTransaction,
    json_name: "canceledTransactions"
end
