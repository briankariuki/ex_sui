defmodule Sui.Rpc.V2beta2.ConsensusCommitPrologue do
  @moduledoc """
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta2.ConsensusDeterminedVersionAssignments",
          default_value: nil,
          options: nil,
          oneof_index: 5,
  ...
  field :consensus_determined_version_assignments, 6,
    proto3_optional: true,
    type: Sui.Rpc.V2beta2.ConsensusDeterminedVersionAssignments,
    json_name: "consensusDeterminedVersionAssignments"
