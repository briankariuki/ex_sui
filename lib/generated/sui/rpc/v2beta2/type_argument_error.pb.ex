defmodule Sui.Rpc.V2beta2.TypeArgumentError do
  @moduledoc """
  Type argument error.
  """
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_ENUM,
          type_name: ".sui.rpc.v2beta2.TypeArgumentError.TypeArgumentErrorKind",
          default_value: nil,
          options: nil,
          oneof_index: 1,
          json_name: "kind",
  ...
  field :kind, 2,
    proto3_optional: true,
    type: Sui.Rpc.V2beta2.TypeArgumentError.TypeArgumentErrorKind,
    enum: true
end
