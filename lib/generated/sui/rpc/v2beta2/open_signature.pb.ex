defmodule Sui.Rpc.V2beta2.OpenSignature do
  @moduledoc """
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          type: :TYPE_ENUM,
          type_name: ".sui.rpc.v2beta2.OpenSignature.Reference",
          default_value: nil,
          options: nil,
          oneof_index: 0,
          json_name: "reference",
  ...
  field :reference, 1,
    proto3_optional: true,
    type: Sui.Rpc.V2beta2.OpenSignature.Reference,
    enum: true

  field :body, 2, proto3_optional: true, type: Sui.Rpc.V2beta2.OpenSignatureBody
end
