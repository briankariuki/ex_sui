defmodule Sui.Rpc.V2beta2.SimulateTransactionResponse do
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta2.CommandResult",
          default_value: nil,
          options: nil,
          oneof_index: nil,
          json_name: "outputs",
  ...
  field :outputs, 2, repeated: true, type: Sui.Rpc.V2beta2.CommandResult
end
