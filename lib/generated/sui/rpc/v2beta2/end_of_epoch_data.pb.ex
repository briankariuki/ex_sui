defmodule Sui.Rpc.V2beta2.EndOfEpochData do
  @moduledoc """
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta2.ValidatorCommitteeMember",
          default_value: nil,
          options: nil,
          oneof_index: nil,
  ...
  field :next_epoch_committee, 1,
    repeated: true,
    type: Sui.Rpc.V2beta2.ValidatorCommitteeMember,
    json_name: "nextEpochCommittee"
  ...
  field :epoch_commitments, 3,
    repeated: true,
    type: Sui.Rpc.V2beta2.CheckpointCommitment,
    json_name: "epochCommitments"
end
