defmodule Sui.Rpc.V2beta2.ChangedObject do
  @moduledoc """
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_ENUM,
          type_name: ".sui.rpc.v2beta2.ChangedObject.InputObjectState",
          default_value: nil,
          options: nil,
          oneof_index: 1,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta2.Owner",
          default_value: nil,
          options: nil,
          oneof_index: 4,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_ENUM,
          type_name: ".sui.rpc.v2beta2.ChangedObject.OutputObjectState",
          default_value: nil,
          options: nil,
          oneof_index: 5,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_ENUM,
          type_name: ".sui.rpc.v2beta2.ChangedObject.IdOperation",
          default_value: nil,
          options: nil,
          oneof_index: 9,
  ...
  field :input_state, 2,
    proto3_optional: true,
    type: Sui.Rpc.V2beta2.ChangedObject.InputObjectState,
    json_name: "inputState",
    enum: true
  ...
  field :input_owner, 5,
    proto3_optional: true,
    type: Sui.Rpc.V2beta2.Owner,
    json_name: "inputOwner"

  field :output_state, 6,
    proto3_optional: true,
    type: Sui.Rpc.V2beta2.ChangedObject.OutputObjectState,
    json_name: "outputState",
    enum: true
  ...
  field :id_operation, 10,
    proto3_optional: true,
    type: Sui.Rpc.V2beta2.ChangedObject.IdOperation,
    json_name: "idOperation",
    enum: true
