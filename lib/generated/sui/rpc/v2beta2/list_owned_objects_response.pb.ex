defmodule Sui.Rpc.V2beta2.ListOwnedObjectsResponse do
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta2.OwnedObject",
          default_value: nil,
          options: nil,
          oneof_index: nil,
          json_name: "objects",
  ...
  field :objects, 1, repeated: true, type: Sui.Rpc.V2beta2.OwnedObject
