defmodule Sui.Rpc.V2beta2.ExecutionTimeObservation do
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          type: :TYPE_ENUM,
          type_name: ".sui.rpc.v2beta2.ExecutionTimeObservation.ExecutionTimeObservationKind",
          default_value: nil,
          options: nil,
          oneof_index: 0,
          json_name: "kind",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          type: :TYPE_MESSAGE,
          type_name: ".sui.rpc.v2beta2.ValidatorExecutionTimeObservation",
          default_value: nil,
          options: nil,
          oneof_index: nil,
  ...
  field :kind, 1,
    proto3_optional: true,
    type: Sui.Rpc.V2beta2.ExecutionTimeObservation.ExecutionTimeObservationKind,
    enum: true

  field :move_entry_point, 2,
    proto3_optional: true,
    type: Sui.Rpc.V2beta2.MoveCall,
    json_name: "moveEntryPoint"

  field :validator_observations, 3,
    repeated: true,
    type: Sui.Rpc.V2beta2.ValidatorExecutionTimeObservation,
    json_name: "validatorObservations"
end
