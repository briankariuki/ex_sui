defmodule Sui.Rpc.V2beta2.SimulateTransactionRequest do
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          label: :LABEL_OPTIONAL,
          type: :TYPE_ENUM,
          type_name: ".sui.rpc.v2beta2.SimulateTransactionRequest.TransactionChecks",
          default_value: nil,
          options: nil,
          oneof_index: 2,
          json_name: "checks",
  ...
  field :transaction, 1, proto3_optional: true, type: Sui.Rpc.V2beta2.Transaction
  ...
  field :checks, 3,
    proto3_optional: true,
    type: Sui.Rpc.V2beta2.SimulateTransactionRequest.TransactionChecks,
    enum: true
